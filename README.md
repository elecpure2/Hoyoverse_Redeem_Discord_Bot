...
> ⚠️ **캐릭터/무기/성유물 정보 기능 (수정 진행 중)**
> 
> 데이터 제공원인 Hakushin 사이트가 폐쇄된 관계로 현재 대체 데이터 소스로 전환 작업 중입니다.
> - ✅ 원신: HoneyHunter World로 전환 완료
> - ✅ 스타레일: Prydwen + StarRailRes로 전환 완료 (한글 지원)
> - 🔧 젠레스 존 제로: Prydwen 기반 전환 진행 중
